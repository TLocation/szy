	 ...
	 <body >
		<div class="search-title">
			...
			<div class="description">
				<a
				href="<%=SystemParam.getSiteRoot() %>/admin/lanmumanager.do?actiontype=get&forwardurl=/admin/sitenavguide.jsp">选择栏目导航</a>|<a  href="<%=SystemParam.getSiteRoot() %>/admin/sitenavmanager.do?actiontype=load">新建站点导航</a>
			</div>
		</div>
					<!-- 搜索控件开始 -->
