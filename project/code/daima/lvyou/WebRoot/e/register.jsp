...
<script type="text/javascript">//JQuery扩展插件Validate

// 在键盘按下提交后验证提交表单
 $(function (){
           
            $.metadata.setType("attr","validate");//使用meta可以将验证规则写在自定义的标签内,JS设置meta
            $("#form1").validate();
 });  
 </script>
</head>
			...
			<div class="reg-box">
				...
				<div class="reg-content">
					...
					<dl>
						<dt>密码:</dt>
						<dd>
							<input type="password" validate="{required:true,messages:{required:'请输入密码'},maxlength:12, }" class="input width250" id="txtPassword"
								name="password"> 
					...
					<dl>
						<dt>邮箱:</dt>
						<!--
						required:true必须输入的字段。email:true必须输入正确格式的电子邮件。messages提示信息
						--><dd>
